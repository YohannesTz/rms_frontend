...
const FooterComponent = () => {
  /* return (
    <div className="text-right text-white fixed bottom-0 w-full shadow-md ">
          ...
          <div>
            ...
            >
              <li className="last:mr-0 md:mr-6">
                <a className="hover:underline">Search Homes</a>
              </li>
              <li className="last:mr-0 md:mr-6">
                <a className="hover:underline">+2519789216</a>
              </li>
              <li className="last:mr-0 md:mr-6">
                <a className="hover:underline">searchHomes@gmail.com</a>
              </li>
            </ul>
          </div>
          <hr
  ...
  /* return (
    <footer aria-label="Site Footer" className="bg-white fixed bottom-0">
